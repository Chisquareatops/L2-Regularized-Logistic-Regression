...
# CREATE PREDICTIONS WITH FASTGRADALGO
...
print('fastgradalgo predictions: ')
print(predictions)

# EVALUATE ACCURACY OF FASTGRADALGO
# Use sklearn.metrics to find the accuracy
accuracy = accuracy_score(Y_test, predictions)
print('fastgradalgo accuracy: ')
print(accuracy)
...
print('fastgradalgo confusion matrix: ')
print(conf_matrix)

# CREATE PREDICTIONS WITH SCIKIT LEARN
# there are many possible parameters for the built in SKL linear model
SKL_model = linear_model.LogisticRegression(penalty='l2', max_iter=1000)
SKL_model.fit(X_train, Y_train)
SKL_predict = SKL_model.predict(X_test)

# Look at the betas to confirm correct execution
print('SKL betas: ')
print(SKL_model.coef_)

# EVALUATE ACCURACY OF SCIKIT LEARN
# Use sklearn.metrics to find the accuracy
SKL_accuracy = accuracy_score(Y_test, SKL_predict)
print('SKL accuracy: ')
print(SKL_accuracy)
...
# TRUE POSITIVES  |  FALSE POSITIVES
# FALSE NEGATIVES | TRUE NEGATIVES
SKL_conf_matrix = confusion_matrix(Y_test, SKL_predict)
print('SKL confusion matrix: ')
print(SKL_conf_matrix)